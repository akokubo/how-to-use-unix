...
(株)コムテック (`http://www` `.comtec.co.jp/`) でのアルバイトのこと。
そこには、 UNIX System V のマニュアルが一揃い完備していて、
とても勉強になった。

しばらくは、 System V 系のシステムとの日々が続くが、 後に SunOS で BSD
系のシステムにも触れることになる。 SunOS では、 make
三昧の日々が続き、すっかり UNIX 系のシステムに はまることになる。
現在では、 FreeBSD 以外に SPARCStation で OpenBSD を走らせる日々。

趣味は、本を読むことと、絵を描くこと、本を作ることなど。
絵を描く時間が取れないのが、最近の悩み。 なお、この本は ASCII の日本語
pLaTeXを FreeBSD や Cygwin の上で 使用して作成した。
...
:   青森コロニー印刷
    ...
    〒 030-0943 青森市 幸畑 字松元 62-3    
    `TEL: 017-738-2021 / FAX: 017-738-6753`
